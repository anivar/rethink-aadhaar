...
1. Aadhaar involves the creation of a centralized database that includes biometrics as well as demographic information (e.g. name, gender, date of birth and address). This could turn into a dangerous tool of social control, especially, but not only, in the hands of an authoritarian government.
...
Articles and reports amplifying these concerns are available on our [Updates page](/blog).
...
We urge the greatest caution from countries that are considering a replication of the Aadhaar model. We would be happy to facilitate field visits for anyone interested in understanding these problems in more detail. Please [write to us](mailto:contact@rethinkaadhaar.in).
