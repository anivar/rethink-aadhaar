...
const RAW = path.resolve('content-source/raw');
const OUT_BLOG = path.resolve('src/content/update');
const OUT_EXC = path.resolve('src/content/exclusion');
...
function processOne(file, prefix, outDir) {
